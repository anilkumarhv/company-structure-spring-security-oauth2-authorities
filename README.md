...
http://localhost:8085/oauth/authorize?audience=test&scope=read&response_type=code&client_id=spring-security-oauth2-read-write-client&redirect_uri=http://localhost:8085&state=1234
will get code and pass